...
public class AmazonSES {
	...
	final String FROM = "hillparkway@gmail.com";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://ec2-18-212-48-190.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ "http://ec2-18-212-48-190.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	final String PASSWORD_RESET_TEXTBODY = "A request to reset your password " + "Hi, $firstName! "
			+ "Someone has requested to reset your password with our project. If it were not you, please REPORT THIS TO ADMIN  it."
...
//	 	 System.setProperty("aws.accessKeyId", "sfagdfgQAPGZSGNYM5");
//		 System.setProperty("aws.secretKey", "hfsagdgshfhdfytuet45y5Fs+rr");
